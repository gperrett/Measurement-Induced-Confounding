...
source('bad_dass_latent_latent.R')
source('bad_dass_latent_item.R')
source('bad_dass_item_item.R')
...
fig4 <- cbind(zbias, coverage = cover$coverage)
fig4 |>
...
ggsave('figures/fig4.pdf', width = 8, height = 3)
